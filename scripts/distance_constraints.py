...
def Get_list_of_connection_constraint_list(connection_list,agent_list,d_connect):
    ...
    items=[[connection_list[i],agent_list,d_connect] for i in range(len(connection_list))]
