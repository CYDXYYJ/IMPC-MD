...
def get_polyhedron_plane(ob,plane_list,vertex_list,next_vertex_list):
    ...
    if not detect_polygon_polygon_collision(ob,poly,3.0):
        ...
        for times in range(8):
            ...
            if detect_polygon_polygon_collision(ob,poly,3.0):
                b=t
            else:
                a=t 
...
def get_distance_list(obstacle_list,polyhedron):
